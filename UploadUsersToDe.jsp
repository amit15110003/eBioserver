			...
			<div id="particles-js">
				<div class="datatable" style="margin-top: 50px;">
					<div class="datatable-top">
						<table width="100%">
							<tr>
								<td width="30%">Upload Users To <input type="text" disabled id="lbldevicename"style="color: #e8e8f3;
...
background-color: #2c2e43;font-family: inherit;border: 0px;font-weight: bold;"></td>
					...
					<div class="datatable-bottom">
						<table width="100%">
							...
							<input type="hidden" name="ValueOfCardPassFinger" id="ValueOfCardPassFinger">
								<td><input type="checkbox"  id="ListBio"> List all Employees with Bio Details</td>
								<td><input type="checkbox"  id="CardCheck"> Card</td>
								<td><input type="checkbox" id="PasswordCheck"> Password</td>
                                 <td><input type="checkbox"onClick="validate()" id="FingerCheck"> FingerPrints</td>  
                                  <td><input type="checkbox"onClick="validate1()" id="FaceCheck"> Face</td>
                                    
								<td><button id="btnUpload" class="Custombtn btn-outline-light" onClick="CreatedAllowedPermission1();">Upload</button></td>
							</tr>
						</table>
					</div>
				</div>
...
<!-----------------------------script for checkbox checked all  -->
		...
		<script type="text/javascript">
	function validate() {
		var finger = document.getElementById('FingerCheck');
		var face = document.getElementById('FaceCheck');

		if (finger.checked)

		{
			document.getElementById("FaceCheck").checked = false;
		}
		
		if(face.checked)
			{
			document.getElementById("FingerCheck").checked = false;
			}
...
<script type="text/javascript">	 
	...
	//document.getElementById("lbldevicename").value=SerialNumber;	
	   ...
	   $.ajax({
		        ...
		        data:{ 
		            ...
		            methodcall : "UserToDevice",
		            ValueOfCardPassFinger: $('#ValueOfCardPassFinger').val(),
	...
	function CreatedAllowedPermission1() {
		...
		if (document.getElementById("CardCheck").checked == true) {
			Allowed = 1;
		}

		if (document.getElementById("PasswordCheck").checked == true) {
			Allowed += " " + 2;
		}

		if (document.getElementById("FingerCheck").checked == true) {
			Allowed += " " + 3;
		}
		if (document.getElementById("FaceCheck").checked == true) {
			Allowed += " " + 4;
		}
		document.getElementById("ValueOfCardPassFinger").value = Allowed;
	}
	</script>
