	...
	<!--==============div for right click==================  -->
		<div class="menu">
			<ul class="menu-options">
			    ...
			    <li><a href="" onclick="this.href='Block.jsp?nav='+document.getElementById('onClickSerialNumber').value+'&?name='+document.getElementById('ShortName').value"class="menu-option" id="UploadUsers"> Block Users To Device</a></li>
			    <li><a href="" onclick="this.href='unblock.jsp?nav='+document.getElementById('onClickSerialNumber').value+'&?name='+document.getElementById('ShortName').value"class="menu-option" id="UploadUsers"> Unblock Users To Device</a></li>
